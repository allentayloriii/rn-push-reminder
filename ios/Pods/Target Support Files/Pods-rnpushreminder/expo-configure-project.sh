...
with_node \
  ...
  --target "/Users/allentaylor/Repos/rn-push-reminder/ios/Pods/Target Support Files/Pods-rnpushreminder/ExpoModulesProvider.swift" \
  --entitlement "/Users/allentaylor/Repos/rn-push-reminder/ios/rnpushreminder/rnpushreminder.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-notifications" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser" "galaxies"
